...
- `rebuild-documentation-governance` is the first child authorized for written specification; applying it still requires review and approval of its exact artifacts.
