...
- [ ] 1.4 Verify that the documentation-governance child routes significant future changes through the approved OpenSpec entrypoints and records the boundary in the repository agent map.

## 2. Documentation Governance Stage

- [ ] 2.1 Obtain user review of the written `rebuild-documentation-governance` artifacts before implementation planning.
- [ ] 2.2 Record approval against the exact artifact digests, then create and approve the detailed implementation plan for the OpenSpec foundation and documentation governance only.
- [ ] 2.3 Apply the documentation-governance child change in verified batches under its own tasks.
- [ ] 2.4 Record user acceptance against the applied revision and verification evidence, then archive the child only after its blocking documentation gate is required and green.
