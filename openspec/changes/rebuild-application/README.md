...
- 每轮用户确认后先同步相关设计文档，再继续下一组；未确认的审视建议不得写成已采用决定。
...
2026-09-07 更新保留上述原编号，补充 `IPD-16` 与 `FC-01`～`FC-13` 记录已确认的组织、命名、角色生图提示词字段、图片导出路径和逐组写回规则；验证结果与完整门禁限制见 [同步验证记录](evidence/2026-09-07-confirmed-design-sync.md)。
