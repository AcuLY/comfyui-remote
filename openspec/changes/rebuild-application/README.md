...
2026-09-07 更新保留上述原编号，补充 `IPD-16`～`IPD-18` 与 `FC-01`～`FC-15` 记录已确认的组织、命名、公共小节与图片配置分层、角色生图提示词字段、文件目录和逐组写回规则；验证结果与完整门禁限制见 [同步验证记录](evidence/2026-09-07-confirmed-design-sync.md)。
