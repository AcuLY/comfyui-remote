...
- [ ] 13.8 Before archive, confirm the sanitized PreToolUse spike remains non-normative attempted-path-match evidence and is not the directly installed implementation; confirm the separately authorized root successor keeps live data ignored and outside this child's acceptance, and record that the later observability child must revalidate both inputs.
