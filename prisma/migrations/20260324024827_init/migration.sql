-- CreateEnum
CREATE TYPE "JobStatus" AS ENUM ('draft', 'queued', 'running', 'partial_done', 'done', 'failed');

-- CreateEnum
CREATE TYPE "RunStatus" AS ENUM ('queued', 'running', 'done', 'failed', 'cancelled');

-- CreateEnum
CREATE TYPE "ReviewStatus" AS ENUM ('pending', 'kept', 'trashed');
...
CREATE TABLE "CompleteJob" (
    ...
    CONSTRAINT "CompleteJob_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "CompleteJobPosition" (
    ...
    CONSTRAINT "CompleteJobPosition_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "PositionRun" (
    ...
    CONSTRAINT "PositionRun_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "CompleteJob" ADD CONSTRAINT "CompleteJob_characterId_fkey" FOREIGN KEY ("characterId") REFERENCES "Character"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CompleteJob" ADD CONSTRAINT "CompleteJob_scenePresetId_fkey" FOREIGN KEY ("scenePresetId") REFERENCES "ScenePreset"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CompleteJob" ADD CONSTRAINT "CompleteJob_stylePresetId_fkey" FOREIGN KEY ("stylePresetId") REFERENCES "StylePreset"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CompleteJobPosition" ADD CONSTRAINT "CompleteJobPosition_completeJobId_fkey" FOREIGN KEY ("completeJobId") REFERENCES "CompleteJob"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CompleteJobPosition" ADD CONSTRAINT "CompleteJobPosition_positionTemplateId_fkey" FOREIGN KEY ("positionTemplateId") REFERENCES "PositionTemplate"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PositionRun" ADD CONSTRAINT "PositionRun_completeJobId_fkey" FOREIGN KEY ("completeJobId") REFERENCES "CompleteJob"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PositionRun" ADD CONSTRAINT "PositionRun_completeJobPositionId_fkey" FOREIGN KEY ("completeJobPositionId") REFERENCES "CompleteJobPosition"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ImageResult" ADD CONSTRAINT "ImageResult_positionRunId_fkey" FOREIGN KEY ("positionRunId") REFERENCES "PositionRun"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TrashRecord" ADD CONSTRAINT "TrashRecord_imageResultId_fkey" FOREIGN KEY ("imageResultId") REFERENCES "ImageResult"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "JobRevision" ADD CONSTRAINT "JobRevision_completeJobId_fkey" FOREIGN KEY ("completeJobId") REFERENCES "CompleteJob"("id") ON DELETE CASCADE ON UPDATE CASCADE;
