...
所有命令都从仓库根目录执行。CodeBuddy Skill 的脚本路径固定为 `.codebuddy/skills/ui-ux-pro-max/scripts/search.py`：

```bash
# POSIX
python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "<查询>" --design-system
```

```powershell
# Windows
python .codebuddy/skills/ui-ux-pro-max/scripts/search.py "<查询>" --design-system
```
...
```bash
python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "<产品类型> <行业> <关键词>" --design-system [-p "项目名称"]
```
...
```bash
python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "美容 水疗 健康 服务" --design-system -p "Serenity Spa"
```
...
```bash
python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "<查询>" --design-system --persist -p "项目名称"
```
...
```bash
python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "<查询>" --design-system --persist -p "项目名称" --page "dashboard"
```
...
```bash
python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "<关键词>" --domain <领域> [-n <最大结果数>]
```
...
```bash
python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "<关键词>" --stack html-tailwind
```
...
2. 生成设计系统：
   ...
   ```bash
   python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "美容 水疗 健康 服务 优雅" --design-system -p "Serenity Spa"
   ```
...
3. 按需补充 UX 与字体搜索：
   ...
   ```bash
   # 查询动画与无障碍准则
   python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "animation accessibility" --domain ux

   # 查询备选字体
   python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "elegant luxury serif" --domain typography
   ```

4. 获取技术栈准则：

   ```bash
   python3 .codebuddy/skills/ui-ux-pro-max/scripts/search.py "layout responsive form" --stack html-tailwind
   ```
