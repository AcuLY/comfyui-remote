...
function buildReferenceImages(images: TrainingImage[], start: number, prefix: string): LoraTrainingReferenceImage[] {
...
function buildImageResults(images: TrainingImage[], start: number, prefix: string): LoraTrainingImageResult[] {
...
function buildDatasetSamples(images: TrainingImage[], start: number, prefix: string): LoraTrainingDatasetSample[] {
