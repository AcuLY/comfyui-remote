...
export const SHOWCASE_COMPONENTS: ShowcaseComponentEntry[] = [
  {
    ...
    paths: ["_shared/primitives", "ui/button"],
  ...
  },
  {
    ...
    paths: ["_shared/primitives", "ui/checkbox"],
  ...
  },
  {
    ...
    paths: ["_shared/primitives", "ui/switch"],
  ...
  },
  {
    ...
    paths: ["_shared/primitives", "ui/status-badge"],
  ...
  },
  {
    ...
    paths: ["_shared/primitives", "ui/segmented-control"],
    usedBy: ["模型文件", "监控", "项目视图"],
    status: "implemented",
  },
  {
    ...
    paths: ["_shared/primitives", "ui/demo-tabs"],
    usedBy: ["任务页", "结果页", "日志页"],
    status: "implemented",
  },
  {
    ...
    paths: ["_shared/primitives", "ui/field", "ui/text-area-field"],
  ...
  },
  {
    ...
    paths: ["_shared/primitives", "ui/page-header"],
    usedBy: ["所有设计 demo 页面"],
    status: "implemented",
  },
  {
  ...
  },
  {
    ...
    paths: ["_shared/primitives", "ui/empty-page", "ui/empty-rows"],
  ...
  },
  {
    ...
    paths: ["_features/projects", "projects/project-list-item"],
    usedBy: ["项目列表页"],
    status: "adapter",
  },
  {
    ...
    paths: ["_features/projects", "projects/project-section-card"],
    usedBy: ["项目详情页"],
    status: "adapter",
  },
  {
    ...
    paths: ["_features/presets", "presets/library-page"],
    usedBy: ["预设库"],
    status: "planned",
  },
  {
    ...
    paths: ["_features/templates", "templates/template-form-page"],
    usedBy: ["模板编辑页"],
    status: "planned",
  },
  {
  ...
  },
  {
    ...
    paths: ["_features/models", "models/models-page"],
    usedBy: ["模型文件管理"],
    status: "planned",
  },
  {
  ...
  },
  {
    ...
    paths: ["_shared/feedback", "ui/operation-state-strip"],
    usedBy: ["预设库", "模板编辑", "登录"],
    status: "implemented",
  },
  {
    ...
    paths: ["_shared/feedback", "ui/feedback"],
    usedBy: ["所有 demo 按钮反馈"],
    status: "implemented",
  },
  {
  ...
  },
  {
    ...
    paths: ["_shared/media", "ui/image-thumb-small", "ui/image-list-small"],
  ...
  },
  {
    ...
    paths: ["_shared/media", "ui/image-thumb-medium", "ui/image-list-medium"],
  ...
  },
  {
    ...
    paths: ["_shared/media", "ui/image-grid", "ui/review-image-board"],
  ...
  },
  {
    ...
    paths: ["_shared/media", "ui/image-preview-frame", "ui/image-preview-large"],
    usedBy: ["审核页", "项目结果页", "小节编辑器"],
    status: "implemented",
  },
  {
    ...
    paths: ["_features/runs", "runs/queue-metrics"],
    usedBy: ["任务页"],
    status: "implemented",
  },
  {
    ...
    paths: ["_features/runs", "runs/current-running-progress-card"],
    usedBy: ["任务页"],
    status: "implemented",
  },
  {
    ...
    paths: ["_features/runs", "runs/run-list", "runs/pending-review-groups"],
    usedBy: ["任务页"],
    status: "implemented",
  },
  {
    ...
    paths: ["_features/runs", "runs/review-meta-card"],
    usedBy: ["审核页"],
    status: "implemented",
  },
  {
    ...
    paths: ["_features/settings", "system/logs-page"],
    usedBy: ["日志页"],
    status: "planned",
  },
  {
    ...
    paths: ["_features/settings", "system/monitor-page"],
    usedBy: ["监控页"],
    status: "planned",
  },
  {
  ...
  },
  {
    ...
    paths: ["_features/auth", "system/login-page"],
    usedBy: ["登录页"],
    status: "planned",
  },
  {
  ...
  },
  {
    ...
    paths: ["_showcase/pages", "route-header-specs"],
    usedBy: ["Headers 专项"],
    status: "specialty",
  },
  {
