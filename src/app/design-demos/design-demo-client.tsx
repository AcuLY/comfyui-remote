...
import { ComponentShowcaseIndex, ComponentShowcaseAtoms, ComponentShowcaseFonts, ComponentShowcaseMid, ComponentShowcaseImages, ComponentShowcaseEditor } from "./component-showcase-page";
...
function CurrentPage({ match, data }: { match: Match; data: DemoData }) {
  ...
  switch (match.key) {
    ...
    case "component-showcase-fonts":
      return <ComponentShowcaseFonts />;
