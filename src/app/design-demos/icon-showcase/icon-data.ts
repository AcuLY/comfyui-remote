...
export const ALL_ICONS: IconEntry[] = [
  ...
  { icon: Check, name: "Check", desc: "确认/勾选", category: "操作", usedIn: ["design-demo-data", "ui", "design-demo-utils", "component-showcase-images", "model-pages", "preset-pages", "project-pages", "runs-page", "section-editor-controls", "section-editor-header", "section-editor-page", "template-pages"] },
  { icon: CheckSquare, name: "CheckSquare", desc: "方框勾选（选中态）", category: "操作", usedIn: ["ui", "component-showcase-images", "preset-pages", "project-pages", "runs-page"] },
  { icon: Square, name: "Square", desc: "方框（未选中态）", category: "操作", usedIn: ["ui", "component-showcase-images", "preset-pages", "project-pages", "runs-page"] },
  { icon: X, name: "X", desc: "关闭/清除/删除", category: "操作", usedIn: ["batch-create-page", "ui", "design-demo-utils", "component-showcase-images", "model-pages", "preset-pages", "project-pages", "runs-page", "section-editor-lora-history", "section-editor-page-data", "system-pages"] },
  ...
  { icon: Trash2, name: "Trash2", desc: "删除/移到回收站", category: "操作", usedIn: ["ui", "component-showcase-images", "model-pages", "preset-pages", "project-pages", "runs-page", "section-editor-page", "section-editor-presets", "section-editor-prompts", "template-pages"] },
  ...
  // 视觉指示
  { icon: Eye, name: "Eye", desc: "查看/可见", category: "视觉指示", usedIn: ["design-demo-shell", "ui", "component-showcase-images", "project-pages", "section-editor-header"] },
  { icon: EyeOff, name: "EyeOff", desc: "隐藏/不可见", category: "视觉指示", usedIn: ["design-demo-shell"] },
  { icon: Star, name: "Star", desc: "收藏/星标/评分", category: "视觉指示", usedIn: ["batch-create-page", "design-demo-data", "ui", "component-showcase-images", "preset-pages", "project-pages", "runs-page", "section-editor-page", "system-pages", "template-pages"] },
  { icon: Archive, name: "Archive", desc: "归档/已归档", category: "视觉指示", usedIn: ["ui", "component-showcase-images", "project-pages"] },
