...
const ALL_ICONS: IconEntry[] = [
  // 导航与方向
  { icon: ArrowLeft, name: "ArrowLeft", desc: "左箭头，返回/上一页", category: "导航与方向", usedIn: ["batch-create-page", "design-demo-ui", "model-pages", "preset-pages", "project-pages", "runs-page", "template-pages"] },
  { icon: ArrowRight, name: "ArrowRight", desc: "右箭头，前进/下一步", category: "导航与方向", usedIn: ["design-demo-ui", "preset-pages", "runs-page", "system-pages", "template-pages"] },
  { icon: ChevronDown, name: "ChevronDown", desc: "向下折叠/展开", category: "导航与方向", usedIn: ["design-demo-ui", "project-pages", "runs-page", "section-editor-controls", "section-editor-presets"] },
  ...
  { icon: ChevronUp, name: "ChevronUp", desc: "向上折叠/收起", category: "导航与方向", usedIn: ["design-demo-ui", "project-pages"] },
  ...
  { icon: Check, name: "Check", desc: "确认/勾选", category: "操作", usedIn: ["design-demo-data", "design-demo-ui", "design-demo-utils", "image-list-components", "model-pages", "preset-pages", "project-pages", "runs-page", "section-editor-controls", "section-editor-header", "section-editor-page", "template-pages"] },
  { icon: CheckSquare, name: "CheckSquare", desc: "方框勾选（选中态）", category: "操作", usedIn: ["design-demo-ui", "image-list-components", "preset-pages", "project-pages", "runs-page"] },
  { icon: Square, name: "Square", desc: "方框（未选中态）", category: "操作", usedIn: ["design-demo-ui", "image-list-components", "preset-pages", "project-pages", "runs-page"] },
  { icon: X, name: "X", desc: "关闭/清除/删除", category: "操作", usedIn: ["batch-create-page", "design-demo-ui", "design-demo-utils", "image-list-components", "model-pages", "preset-pages", "project-pages", "runs-page", "section-editor-lora-history", "section-editor-page-data", "system-pages"] },
  ...
  { icon: Trash2, name: "Trash2", desc: "删除/移到回收站", category: "操作", usedIn: ["design-demo-ui", "image-list-components", "model-pages", "preset-pages", "project-pages", "runs-page", "section-editor-page", "section-editor-presets", "section-editor-prompts", "template-pages"] },
  ...
  // 视觉指示
  { icon: Eye, name: "Eye", desc: "查看/可见", category: "视觉指示", usedIn: ["design-demo-shell", "design-demo-ui", "image-list-components", "project-pages", "section-editor-header"] },
  { icon: EyeOff, name: "EyeOff", desc: "隐藏/不可见", category: "视觉指示", usedIn: ["design-demo-shell"] },
  { icon: Star, name: "Star", desc: "收藏/星标/评分", category: "视觉指示", usedIn: ["batch-create-page", "design-demo-data", "design-demo-ui", "image-list-components", "preset-pages", "project-pages", "runs-page", "section-editor-page", "system-pages", "template-pages"] },
  { icon: Archive, name: "Archive", desc: "归档/已归档", category: "视觉指示", usedIn: ["design-demo-ui", "image-list-components", "project-pages"] },
  ...
  // 业务对象
  { icon: Activity, name: "Activity", desc: "活动/心跳/运行状态", category: "业务对象", usedIn: ["design-demo-ui", "system-pages"] },
  ...
  { icon: ImageIcon, name: "ImageIcon", desc: "图片/图像", category: "业务对象", usedIn: ["design-demo-ui", "design-demo-utils", "project-pages", "runs-page", "section-editor-page"] },
  ...
  { icon: Tags, name: "Tags", desc: "标签/分类", category: "业务对象", usedIn: ["design-demo-ui", "design-demo-utils"] },
