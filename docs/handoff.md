...
- Prisma schema 覆盖：PromptCategory、PromptPreset、Project（含 presetBindings JSON 字段）、ProjectSection、SectionRun、ImageResult、TrashRecord、LoraAsset、ProjectRevision、AuditLog、PromptBlock（含 categoryId 字段）
