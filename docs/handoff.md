...
- `src/app/` — 16 个页面 + 27 个 API 路由
- `src/lib/` — 共享工具（prisma client、server-data 查询、server actions、类型）
- `src/server/services/` — Service 层（业务逻辑 + 输入校验 + workflow 模板服务）
...
- `agent-api.md`：Agent API 完整使用说明（端点、请求格式、典型工作流）
