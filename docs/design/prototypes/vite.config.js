...
export default defineConfig({
  ...
  plugins: [{
    ...
    generateBundle() {
      for (const fileName of ['README.md', 'foundations/README.md', 'design-foundations.md', 'ui-design-roadmap.md', 'ui-design-coverage.md', 'ui-design-shared-plan.md', 'ui-design-production-plan.md', 'ui-design-training-plan.md', 'reviews/R01.md', 'reviews/R01-02.md', 'reviews/R02-01.md', 'reviews/F-responsive.md', 'reviews/F-theme.md', 'src/theme/README.md', 'src/theme/LICENSE.primereact-sass-theme', 'src/theme/vendor/primereact-sass-theme/UPSTREAM.json', '.impeccable/design.json']) {
