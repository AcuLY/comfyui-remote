...
本区域保留[根设计契约](../../DESIGN.md)之下的功能规划、交互语义、无障碍要求及运行时职责。上一轮原型及其批准基线不再适用；2026-09-16 按用户要求沿用 `design-demos` 风格重新开始[基础组件与任务页原型](../../prototypes/task-workspace/README.md)，当前待用户评审。
