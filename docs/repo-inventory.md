...
| `openspec/changes/rebuild-documentation-governance/evidence/2026-07-13-workflow-production-migration.md` | `openspec` | `repository-maintainers` | `Markdown` 文档 | `openspec` | 治理策略 |
...
| `prototypes/app/.gitignore` | `prototypes` | `repository-maintainers` | 仓库文件 | `仓库文件` | 通用回退 |
| `prototypes/app/DESIGN.md` | `prototypes` | `repository-maintainers` | `Markdown` 文档 | `source-adjacent` | 治理策略 |
| `prototypes/app/README.md` | `prototypes` | `repository-maintainers` | `Markdown` 文档 | `source-adjacent` | 治理策略 |
| `prototypes/app/index.html` | `prototypes` | `repository-maintainers` | 网页资产 | `仓库文件` | 通用回退 |
| `prototypes/app/package-lock.json` | `prototypes` | `repository-maintainers` | 结构化数据 | `仓库文件` | 通用回退 |
| `prototypes/app/package.json` | `prototypes` | `repository-maintainers` | 结构化数据 | `仓库文件` | 通用回退 |
| `prototypes/app/scripts/build-theme.mjs` | `prototypes` | `repository-maintainers` | 源码 | `仓库文件` | 通用回退 |
| `prototypes/app/src/App.tsx` | `prototypes` | `repository-maintainers` | 源码 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets.d.ts` | `prototypes` | `repository-maintainers` | 源码 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/LICENSE` | `prototypes` | `repository-maintainers` | 仓库文件 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular.css` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_00a682.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_0f9ed6.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_121ef3.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_170a05.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_17f172.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_217dc2.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_256855.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_272cc0.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_27c723.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_28749b.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_2b1dc1.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_2dce0b.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_3056fd.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_312071.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_375414.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_39f71f.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_3ef9bb.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_3fc7ac.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_409c84.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_44123f.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_449d8d.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_45ef02.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_47cfe5.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_4d7a5e.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_4fed1d.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_533bb6.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_68d530.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_6acba8.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_6cf07f.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_6dd231.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_6fde5a.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_7058e1.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_7a0ff1.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_7c169d.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_7ef7a1.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_7f7d1c.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_83d7dd.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_84452c.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_84f7ac.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_86f2d2.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_88d643.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_8a3521.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_8b2a9d.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_8c54f5.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_8ef126.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_8fcd67.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_92d092.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_95b6b4.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_96734e.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_997d05.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_9dbf33.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_a2360c.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_a3f550.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_a4d91f.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_a9cfd5.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_a9e9db.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_aab13d.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_ac4458.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_b00490.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_b13597.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_b2c226.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_b2e109.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_b62ca1.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_c59db4.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_cdc930.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_d0a30d.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_d605af.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_d892dd.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_d9b42a.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_da4d56.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_de2c82.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_e17466.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_e39c0d.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_ea8896.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_eccccb.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_f07e53.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_f61d6a.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_f64fe5.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_f796c7.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_fda05f.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_fe0341.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/harmonyos-sans-sc/Regular_fff490.woff2` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/ibm-plex-mono/IBMPlexMono-Bold.ttf` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/ibm-plex-mono/IBMPlexMono-Medium.ttf` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/ibm-plex-mono/IBMPlexMono-Regular.ttf` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/ibm-plex-mono/IBMPlexMono-SemiBold.ttf` | `prototypes` | `repository-maintainers` | 字体资产 | `仓库文件` | 通用回退 |
| `prototypes/app/src/assets/fonts/ibm-plex-mono/OFL.txt` | `prototypes` | `repository-maintainers` | 仓库文件 | `仓库文件` | 通用回退 |
| `prototypes/app/src/data.ts` | `prototypes` | `repository-maintainers` | 源码 | `仓库文件` | 通用回退 |
| `prototypes/app/src/feedback.tsx` | `prototypes` | `repository-maintainers` | 源码 | `仓库文件` | 通用回退 |
| `prototypes/app/src/fonts.css` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
...
| `prototypes/app/src/prototype-provider.tsx` | `prototypes` | `repository-maintainers` | 源码 | `仓库文件` | 通用回退 |
...
| `prototypes/app/src/styles.css` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/src/tasks/TaskDetailSidebar.tsx` | `prototypes` | `repository-maintainers` | 源码 | `仓库文件` | 通用回退 |
| `prototypes/app/src/tasks/task-parts.tsx` | `prototypes` | `repository-maintainers` | 源码 | `仓库文件` | 通用回退 |
| `prototypes/app/src/tasks/useTasks.ts` | `prototypes` | `repository-maintainers` | 源码 | `仓库文件` | 通用回退 |
| `prototypes/app/src/theme.generated.css` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
...
| `prototypes/app/theme/LICENSE.primereact-sass-theme` | `prototypes` | `repository-maintainers` | 仓库文件 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/README.md` | `prototypes` | `repository-maintainers` | `Markdown` 文档 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/theme-inputs.mjs` | `prototypes` | `repository-maintainers` | 源码 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/tokens.css` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/UPSTREAM.json` | `prototypes` | `repository-maintainers` | 结构化数据 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/_colors.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/_common.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/_components.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/_mixins.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/button/_button.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/button/_speeddial.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/button/_splitbutton.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/data/_carousel.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/data/_datascroller.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/data/_datatable.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/data/_dataview.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/data/_filter.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/data/_orderlist.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/data/_organizationchart.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/data/_paginator.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/data/_picklist.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/data/_timeline.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/data/_tree.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/data/_treetable.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/file/_fileupload.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_autocomplete.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_calendar.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_cascadeselect.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_checkbox.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_chips.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_colorpicker.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_dropdown.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_editor.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_iconfield.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_inputgroup.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_inputicon.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_inputnumber.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_inputotp.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_inputswitch.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_inputtext.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_listbox.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_mention.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_multiselect.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_password.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_radiobutton.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_rating.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_selectbutton.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_slider.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_togglebutton.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_treeselect.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/input/_tristatecheckbox.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/menu/_breadcrumb.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/menu/_contextmenu.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/menu/_dock.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/menu/_megamenu.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/menu/_menu.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/menu/_menubar.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/menu/_panelmenu.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/menu/_slidemenu.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/menu/_steps.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/menu/_tabmenu.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/menu/_tieredmenu.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/messages/_inlinemessage.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/messages/_message.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/messages/_toast.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/misc/_avatar.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/misc/_badge.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/misc/_blockui.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/misc/_chip.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/misc/_inplace.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/misc/_metergroup.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/misc/_progressbar.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/misc/_scrolltop.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/misc/_skeleton.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/misc/_tag.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/misc/_terminal.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/multimedia/_galleria.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/multimedia/_image.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/overlay/_confirmpopup.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/overlay/_dialog.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/overlay/_overlaypanel.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/overlay/_sidebar.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/overlay/_tooltip.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/panel/_accordion.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/panel/_card.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/panel/_divider.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/panel/_fieldset.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/panel/_panel.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/panel/_scrollpanel.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/panel/_splitter.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/panel/_stepper.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/panel/_tabview.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/theme-base/components/panel/_toolbar.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/themes/lara/lara-dark/_variables.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
| `prototypes/app/theme/vendor/primereact-sass-theme/themes/lara/lara-light/_variables.scss` | `prototypes` | `repository-maintainers` | 样式 | `仓库文件` | 通用回退 |
