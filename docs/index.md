...
| training | `docs/plans/2026-06-07-manager-lora-training-docs-index.md`, `docs/prototypes/README.md`, `src/features/training`, `src/server/services/training` | product/design reference plus current source | training | training route, API, service, repository, or prototype changes | training frontend/API/service tests |
