...
| UI design | `DESIGN.md`, `docs/frontend-design-guide.md`, `docs/design-demos-frontend-parity.md`, `docs/ui/component-boundaries.md` | product/design reference | ui-design-system | shared shell, page pattern, token, accessibility, or design-demo changes | UI/source-contract tests |
